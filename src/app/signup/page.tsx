...
function SignUpPage() {
  ...
  return (
    ...
    <nav className="h-[10vh] flex justify-between items-center px-10">
        ...
        className="text-2xl/7 font-bold text-black dark:text-white sm:truncate sm:text-3xl sm:tracking-tight">InSights</h1>
    </nav>
      <div className="flex min-h-[90vh] flex-1 flex-col  px-6 py-12 lg:px-8 dark:bg-black bg-gray-100">
